...
\begin{frame}
  \frametitle{ROLE (Responsive Open Learning Environments)}
      \begin{description}[]
        \item[ROLE] \hfill \\
        \begin{itemize}
          \item Learning environment in the web
          \item Personalized with widgets (inter-widget-communication)
          \item Collaborative learning (inter-device-communication)
          \item[$\Rightarrow$] Use of inter-device-communication\\
                               and synergies with other widgets
        \end{itemize}
      \end{description}
\end{frame}
