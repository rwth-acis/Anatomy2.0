...
\subsection{General Workflow} % (fold)
...
\end{enumerate}
% subsection general_workflow (end)

\newpage

\subsection{Issue Schema} % (fold)
...
\end{itemize}
% subsection issue_schema (end)


\subsection{Test Case Schema} % (fold)
...
the test
\end{itemize}
% subsection test_case_schema (end)


\subsection{Test Log Schema} % (fold)
...
\end{itemize}
% subsection test_log_schema (end)


\subsection{Debugging / performance measurement tools} % (fold)
...
\end{tabular}
% subsection debugging_tools (end)
